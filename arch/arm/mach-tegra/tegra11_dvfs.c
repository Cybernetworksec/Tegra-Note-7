...
static struct cpu_cvb_dvfs cpu_cvb_dvfs_table[] = {
	...
	},
	{
		...
		.cvb_table = {
			...
			{2014500, { 3486055, -184086, 3576}, { 1400000,    0,    0} },
			{2116500, { 3576709, -186566, 3576}, { 1400000,    0,    0} },
			{      0, {       0,       0,    0}, {       0,    0,    0} },
		},
		.therm_trips_table = { 20, },
		.therm_floors_table = { 1000, },
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("2d",     -1,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  708000,  636000,  672000,  828000),
	CORE_DVFS("3d",     -1,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  708000,  636000,  672000,  828000),
	CORE_DVFS("epp",    -1,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  708000,  636000,  672000,  828000),
	...
	CORE_DVFS("c2bus",  -1,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  708000,  636000,  672000,  828000),
	CORE_DVFS("c2bus",  -1,  1, 1, KHZ,   240000, 300000, 384000, 468000,  528000,  564000,  708000,  636000,  672000,  828000),
	...
	OVRRD_DVFS("sdmmc1",  0,  0, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  156000,  204000,  204000),
	OVRRD_DVFS("sdmmc3",  0,  0, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  156000,  204000,  204000),
	OVRRD_DVFS("sdmmc4",  0,  0, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  156000,  200000,  200000),
	...
	OVRRD_DVFS("sdmmc4",  0,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  200000,  200000,  200000),

	OVRRD_DVFS("sdmmc1",  1,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  156000,  204000,  204000),
	OVRRD_DVFS("sdmmc3",  1,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  156000,  204000,  204000),
	OVRRD_DVFS("sdmmc4",  1,  1, 1, KHZ,       1,  81600,  81600,  81600,   81600,  156000,  204000,  156000,  200000,  200000),
